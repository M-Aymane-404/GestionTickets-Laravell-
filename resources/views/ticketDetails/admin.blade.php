        ...
        <div class="col-8 ticket  ">
            <div class="etatBare row mt-3  ">
                 @if ($ticket->etat == 'nouveau')
                         ...
                         <form class="etatButton " class="col  " action="{{ route('updateEtat.admin',$ticket) }}" method="POST">
                            @csrf
                            @method('PATCH')
                         ...
                         <form class="etatButton row" action="{{ route('updateEtat.admin',$ticket) }}" method="POST">
                            @csrf
                            @method('PATCH')
                             <div  class="col-1" >Nouveau</div>
