...
<div class="col d-flex justify-content-center">
            ...
            @foreach ($tickets as $ticket)
                ...
                <div class="col d-flex align-items-center justify-content-center "><strong>Demandeur  </strong>: {{ $Demandeur->firstName }}</div>
                <div class="col d-flex align-items-center  justify-content-center view"><strong>Action    </strong>: <a style="  margin-left :10px; " href="{{ route('ticketDetails.client',$ticket) }}">view</a></div>
